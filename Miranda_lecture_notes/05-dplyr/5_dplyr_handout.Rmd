...
produce$price * produce$quantity
...
We have lost all of our original columns, and just have the summary values.  We can also do this by extracting a column directly:
...
produce %>% 
  ...
  relocate(cost, totalGroupCost, percOfGroupCost, item, type) %>% 
  arrange(type)
```
