...
The end goal of this assignment is to compare the obesity percentage in each zip code and sex with the college educated percentage. Both dataframes contain data on Wisconsin residents.
...
What do each of these four quantities represent in real terms? Do not use technical vocabulary.


- <span style="color:#5858d0">  `w` is the number of zip codes in Wisconsin. </span>

- <span style="color:#5858d0">  `x` is the number of zip codes in which the percentage of women with a bachelors degree is higher than the percentage of men with a bachelors degree. </span>

- <span style="color:#5858d0">  `y` is the percentage of zip codes in which the percentage of women with a bachelors degree is higher than the percentage of men with a bachelors degree. </span>

- <span style="color:#5858d0">  `z` is the number of zip codes in which both the percentage of women with a bachelors degree and the percentage of men with a bachelors degree are unknown. </span>
...
<span style="color:#5858d0"> Points below the red line represent a zip code in which the percentage of women with a bachelors degree is higher than the percentage of men with a bachelors degree. </span>
...
- Rename columns `pct_f_bach` and `pct_m_bach` to `female` and `male`.

- **Pivot** the dataframe to be **longer** such that you have TWO rows per zip code; one for each sex within zip.

- Make the column names after pivoting: `zip`, `sex`, and `pct_bachelors`.
...
- Remove all rows with data about the youngest age group (05-17), since the `education_long` dataset is only about adults.
...
<span style="color:#5858d0"> Answer to bonus question: We needed to know the `pop` from every single row to calculate total population of a zip-sex combo, even if there were no obese people in that row. If we would have cleared out the 0 obese rows early, we would have lost some population. </span>
...
<span style="color:#5858d0"> As the percentage of adults with a bachelor's degree goes up, the percentage of adults with obesity tends to decrease. </span>
...
Let these values be printed as output.
