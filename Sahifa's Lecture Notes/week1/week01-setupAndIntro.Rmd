...
* The [course GitHub](https://github.com/MirandaRintoulBadger/STAT240_FA25) is a model for how directories should be created on your local computer!
...
* From the [course GitHub](https://github.com/MirandaRintoulBadger/STAT240_FA25), navigate to `Sahifa_Lecture_Notes/week1`.

* **Download** `week01-setupAndIntro.Rmd` into the folder on your computer `STAT240/lecture/week1`.
