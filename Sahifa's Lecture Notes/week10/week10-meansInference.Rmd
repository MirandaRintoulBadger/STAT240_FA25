...
> By replacing $\sigma$, the **population** standard deviation, with $s$, the **sample** standard deviation, in the above statement, we get $\frac{\bar{x} - \mu}{s/\sqrt{n}} \sim t(df = n -1)$.
...
## Step 4: Identify Relevant Outcomes from Data and p-value.
...
**Step 4: Identify Relevant Outcomes from Data and Alt. Hyp and Calculate P-Value**
