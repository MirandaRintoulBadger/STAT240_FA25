...
-   The general adjustment here is that if your confidence level is $c = 1-\alpha$ (the middle portion), then the right endpoint is the $1- \dfrac{\alpha}{2}$ or $c+\dfrac{(1-c)}{2}$ quantile of the sampling distribution. (Start at right tail, that is 1, then go $\alpha/2$ to remove the tail.)
...
-   ... the **Critical value** also known as **quantile confidence score** is the ($c$ + (1-$c$)/2) or $1- \dfrac{\alpha}{2}$ quantile of the sampling distribution...
