...
* Download `week09-proportionInference.Rmd` to `STAT240/lecture/week09`.
...
### Agresti-Coull Adjustment for p1-p2

> The **Agresti-Coull** adjustment can be thought of as the **difference in proportions** version of the single proportion **Agresti-Coull** adjustment.

> Just like its single proportion equivalent, this "AC" adjustment adds two successes and four failures to the dataset; but for two proportions, we **split them evenly amongst the two groups.**
...
* With the Agresti-Coull adjustment,
...
* Using the Agresti-Coull adjustment, we can finally arrive at our final form for a confidence interval for a difference in proportions:
